...
#: acquire's scoped ``lock_timeout`` (the limiter's log-style bucket
#: lock) — and is converted there to the limiter's fail-closed denial,
#: so one reaching this classifier means a leaked or operator-set
