...
def _worker_env(
    ...
    return {
        ...
        # Watchdog off: this test drives Redis-outage degradation, not the
        # detectors; the 3s lease cannot host a lag budget that is both
        # inside the lease and above the check interval.
